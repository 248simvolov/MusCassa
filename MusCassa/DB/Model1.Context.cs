...
namespace MusCassa.DB
{
    ...
    public partial class MusCassaEntities : DbContext
    {
        public MusCassaEntities()
            : base("name=MusCassaEntities")
        {
        }
        ...
        public virtual DbSet<ЭкспонатВыставка> ЭкспонатВыставка { get; set; }
